...
double *dev_nt = NULL;
cudaMalloc(&dev_nt, XSIZE*YSIZE);
double *dev_tran = NULL;
cudaMalloc(&dev_tran, XSIZE*YSIZE);
double *dev_nd = NULL;
cudaMalloc(&dev_nd, XSIZE*YSIZE);
double *dev_ramD = NULL;
cudaMalloc(&dev_ramD, XSIZE*YSIZE);
double *dev_nr = NULL;
cudaMalloc(&dev_nr, XSIZE*YSIZE);
double *dev_ramR = NULL;
cudaMalloc(&dev_ramR, XSIZE*YSIZE);
unsigned int out = 1;
