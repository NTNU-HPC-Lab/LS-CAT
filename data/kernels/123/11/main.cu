...
double *vu = NULL;
cudaMalloc(&vu, XSIZE*YSIZE);
double *vv = NULL;
cudaMalloc(&vv, XSIZE*YSIZE);
double *vd = NULL;
cudaMalloc(&vd, XSIZE*YSIZE);
double *weights = NULL;
cudaMalloc(&weights, XSIZE*YSIZE);
double *randvals = NULL;
cudaMalloc(&randvals, XSIZE*YSIZE);
int n_features = 1;
double *u_sampled = NULL;
cudaMalloc(&u_sampled, XSIZE*YSIZE);
double *v_sampled = NULL;
cudaMalloc(&v_sampled, XSIZE*YSIZE);
double *d_sampled = NULL;
cudaMalloc(&d_sampled, XSIZE*YSIZE);
double *vu_sampled = NULL;
cudaMalloc(&vu_sampled, XSIZE*YSIZE);
double *vv_sampled = NULL;
cudaMalloc(&vv_sampled, XSIZE*YSIZE);
double *vd_sampled = NULL;
cudaMalloc(&vd_sampled, XSIZE*YSIZE);
int iXSIZE= XSIZE;
int iYSIZE= YSIZE;
