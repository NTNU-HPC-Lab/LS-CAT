...
cudaMalloc(&dlayer1, XSIZE*YSIZE);
const float *dlayer1i = NULL;
cudaMalloc(&dlayer1i, XSIZE*YSIZE);
const float *dlayer1o = NULL;
cudaMalloc(&dlayer1o, XSIZE*YSIZE);
const float *in = NULL;
cudaMalloc(&in, XSIZE*YSIZE);
float *dsyn1 = NULL;
cudaMalloc(&dsyn1, XSIZE*YSIZE);
float *dsyn1i = NULL;
cudaMalloc(&dsyn1i, XSIZE*YSIZE);
float *dsyn1o = NULL;
cudaMalloc(&dsyn1o, XSIZE*YSIZE);
const float alpha = 1;
int iXSIZE= XSIZE;
int iYSIZE= YSIZE;
