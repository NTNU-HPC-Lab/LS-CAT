...
uint8_t *hashes = NULL;
cudaMalloc(&hashes, XSIZE*YSIZE);
uint32_t *sort_indices = NULL;
cudaMalloc(&sort_indices, XSIZE*YSIZE);
uint32_t *off_map = NULL;
cudaMalloc(&off_map, XSIZE*YSIZE);
uint32_t *comb_count = NULL;
cudaMalloc(&comb_count, XSIZE*YSIZE);
uint32_t *comb_sum = NULL;
cudaMalloc(&comb_sum, XSIZE*YSIZE);
uint32_t *comb_prefix = NULL;
cudaMalloc(&comb_prefix, XSIZE*YSIZE);
uint32_t r = 1;
