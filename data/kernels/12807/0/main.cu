...
cudaMalloc(&resultPossibilities, XSIZE*YSIZE);
char *query = NULL;
cudaMalloc(&query, XSIZE*YSIZE);
char *atribsValues = NULL;
cudaMalloc(&atribsValues, XSIZE*YSIZE);
double *possibilities = NULL;
cudaMalloc(&possibilities, XSIZE*YSIZE);
int *queryPrefix = NULL;
cudaMalloc(&queryPrefix, XSIZE*YSIZE);
int *atribsPrefix = NULL;
cudaMalloc(&atribsPrefix, XSIZE*YSIZE);
int *answersNumber = NULL;
cudaMalloc(&answersNumber, XSIZE*YSIZE);
int *categoriesNumber = NULL;
cudaMalloc(&categoriesNumber, XSIZE*YSIZE);
int *atribsNumber = NULL;
cudaMalloc(&atribsNumber, XSIZE*YSIZE);
int iXSIZE= XSIZE;
int iYSIZE= YSIZE;
