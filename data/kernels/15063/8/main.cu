...
cudaMalloc(&d_postEdge1, XSIZE*YSIZE);
float *d_postEdge2 = NULL;
cudaMalloc(&d_postEdge2, XSIZE*YSIZE);
float *d_postGradient1 = NULL;
cudaMalloc(&d_postGradient1, XSIZE*YSIZE);
float *d_postGradient2 = NULL;
cudaMalloc(&d_postGradient2, XSIZE*YSIZE);
float *d_postGradient3 = NULL;
cudaMalloc(&d_postGradient3, XSIZE*YSIZE);
float *d_postSobel3LR = NULL;
cudaMalloc(&d_postSobel3LR, XSIZE*YSIZE);
float *d_postSobel3UD = NULL;
cudaMalloc(&d_postSobel3UD, XSIZE*YSIZE);
float *d_postSmooth31 = NULL;
cudaMalloc(&d_postSmooth31, XSIZE*YSIZE);
float *d_output = NULL;
