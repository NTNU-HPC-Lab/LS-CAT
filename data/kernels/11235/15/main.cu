...
cudaMalloc(&origin, XSIZE*YSIZE);
const float *adjoint = NULL;
cudaMalloc(&adjoint, XSIZE*YSIZE);
const float *primal = NULL;
cudaMalloc(&primal, XSIZE*YSIZE);
const float *prevMaxs = NULL;
cudaMalloc(&prevMaxs, XSIZE*YSIZE);
const float *prevMaxIndices = NULL;
cudaMalloc(&prevMaxIndices, XSIZE*YSIZE);
const float *prevSums = NULL;
cudaMalloc(&prevSums, XSIZE*YSIZE);
float *out = NULL;
