...
cudaMalloc(&nodeWeights, XSIZE*YSIZE);
int *swap_to = NULL;
cudaMalloc(&swap_to, XSIZE*YSIZE);
int *swap_from = NULL;
cudaMalloc(&swap_from, XSIZE*YSIZE);
int *swap_index = NULL;
cudaMalloc(&swap_index, XSIZE*YSIZE);
float *desirability = NULL;
cudaMalloc(&desirability, XSIZE*YSIZE);
int iXSIZE= XSIZE;
int iYSIZE= YSIZE;
