...
cudaMalloc(&p_Src, XSIZE*YSIZE);
int nSrcPitch = 2;
int nSrcHeight = YSIZE;
uint8_t *dpDst0 = NULL;
cudaMalloc(&dpDst0, XSIZE*YSIZE);
uint8_t *dpDst1 = NULL;
cudaMalloc(&dpDst1, XSIZE*YSIZE);
uint8_t *dpDst2 = NULL;
cudaMalloc(&dpDst2, XSIZE*YSIZE);
int nDstWidth = XSIZE;
int nDstHeight = YSIZE;
int *lookupTable_cuda = NULL;
cudaMalloc(&lookupTable_cuda, XSIZE*YSIZE);
int iXSIZE= XSIZE;
int iYSIZE= YSIZE;
