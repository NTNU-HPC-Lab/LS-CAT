#include "includes.h"
__global__ void foregroundMaskUpsampleFilterKernel( cudaTextureObject_t subsampled_mask, unsigned upsample_rows, unsigned upsample_cols, const float sigma, cudaSurfaceObject_t upsampled_mask, cudaSurfaceObject_t filter_mask ) {
