...
double *dMap = NULL;
cudaMalloc(&dMap, XSIZE*YSIZE);
double *dSupFeature = NULL;
cudaMalloc(&dSupFeature, XSIZE*YSIZE);
double *dMaxSupFeature = NULL;
cudaMalloc(&dMaxSupFeature, XSIZE*YSIZE);
double *dMeanSupFeature = NULL;
cudaMalloc(&dMeanSupFeature, XSIZE*YSIZE);
double *dInfFeature = NULL;
cudaMalloc(&dInfFeature, XSIZE*YSIZE);
double *dMaxInfFeature = NULL;
cudaMalloc(&dMaxInfFeature, XSIZE*YSIZE);
double *dMeanInfFeature = NULL;
cudaMalloc(&dMeanInfFeature, XSIZE*YSIZE);
