...
int *nlist = NULL;
cudaMalloc(&nlist, XSIZE*YSIZE);
const int nlist_size = 1;
const int nloc = 1;
const int *jrange = NULL;
cudaMalloc(&jrange, XSIZE*YSIZE);
const int *jlist = NULL;
cudaMalloc(&jlist, XSIZE*YSIZE);
int_64 *key = NULL;
cudaMalloc(&key, XSIZE*YSIZE);
const int *sec_a = NULL;
cudaMalloc(&sec_a, XSIZE*YSIZE);
const int sec_a_size = 1;
int *nei_iter_dev = NULL;
cudaMalloc(&nei_iter_dev, XSIZE*YSIZE);
