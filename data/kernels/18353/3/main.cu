...
cudaMalloc(&prefixed_index, XSIZE*YSIZE);
int64_t *index_in = NULL;
cudaMalloc(&index_in, XSIZE*YSIZE);
int64_t *offsets_in = NULL;
cudaMalloc(&offsets_in, XSIZE*YSIZE);
int64_t *mask_out = NULL;
cudaMalloc(&mask_out, XSIZE*YSIZE);
int64_t *starts_out = NULL;
cudaMalloc(&starts_out, XSIZE*YSIZE);
int64_t *stops_out = NULL;
cudaMalloc(&stops_out, XSIZE*YSIZE);
int64_t length = 1;
int iXSIZE= XSIZE;
int iYSIZE= YSIZE;
