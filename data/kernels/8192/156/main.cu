...
cudaMalloc(&weightsGradPtr, XSIZE*YSIZE);
float *biasGradPtr = NULL;
cudaMalloc(&biasGradPtr, XSIZE*YSIZE);
float *weightsGradCurvePtr = NULL;
cudaMalloc(&weightsGradCurvePtr, XSIZE*YSIZE);
float *biasGradCurvePtr = NULL;
cudaMalloc(&biasGradCurvePtr, XSIZE*YSIZE);
float *avgWeightGradPtr = NULL;
cudaMalloc(&avgWeightGradPtr, XSIZE*YSIZE);
float *avgBiasGradPtr = NULL;
cudaMalloc(&avgBiasGradPtr, XSIZE*YSIZE);
float *avgWeightGradVarPtr = NULL;
cudaMalloc(&avgWeightGradVarPtr, XSIZE*YSIZE);
float *avgBiasGradVarPtr = NULL;
cudaMalloc(&avgBiasGradVarPtr, XSIZE*YSIZE);
float *avgWeightGradCurvePtr = NULL;
cudaMalloc(&avgWeightGradCurvePtr, XSIZE*YSIZE);
float *avgBiasGradCurvePtr = NULL;
cudaMalloc(&avgBiasGradCurvePtr, XSIZE*YSIZE);
float *avgWeightGradCurveVarPtr = NULL;
cudaMalloc(&avgWeightGradCurveVarPtr, XSIZE*YSIZE);
float *avgBiasGradCurveVarPtr = NULL;
cudaMalloc(&avgBiasGradCurveVarPtr, XSIZE*YSIZE);
float *weightMemorySizePtr = NULL;
cudaMalloc(&weightMemorySizePtr, XSIZE*YSIZE);
float *biasMemorySizePtr = NULL;
cudaMalloc(&biasMemorySizePtr, XSIZE*YSIZE);
float *dropoutMaskPtr = NULL;
cudaMalloc(&dropoutMaskPtr, XSIZE*YSIZE);
