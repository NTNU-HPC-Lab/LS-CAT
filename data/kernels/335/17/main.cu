...
cudaMalloc(&d_thresholds_for_action_potential_spikes, XSIZE*YSIZE);
float *d_resting_potentials = NULL;
cudaMalloc(&d_resting_potentials, XSIZE*YSIZE);
...
cudaMalloc(&d_bitarray_of_neuron_spikes, XSIZE*YSIZE);
