...
cudaMalloc(&d_colSums, XSIZE*YSIZE);
const float *d_systemMatrixVals = NULL;
cudaMalloc(&d_systemMatrixVals, XSIZE*YSIZE);
const int *d_systemMatrixRows = NULL;
cudaMalloc(&d_systemMatrixRows, XSIZE*YSIZE);
const int *d_systemMatrixCols = NULL;
cudaMalloc(&d_systemMatrixCols, XSIZE*YSIZE);
