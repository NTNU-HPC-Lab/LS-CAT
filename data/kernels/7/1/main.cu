...
float *forces1 = NULL;
cudaMalloc(&forces1, XSIZE*YSIZE);
float *forces2 = NULL;
cudaMalloc(&forces2, XSIZE*YSIZE);
float *mass = NULL;
cudaMalloc(&mass, XSIZE*YSIZE);
float blockDelta = 1;
int *blocks = NULL;
...
cudaMalloc(&hessiannums, XSIZE*YSIZE);
int *hessiansizes = NULL;
cudaMalloc(&hessiansizes, XSIZE*YSIZE);
int setnum = 1;
int N = XSIZE*YSIZE;
int iXSIZE= XSIZE;
int iYSIZE= YSIZE;
