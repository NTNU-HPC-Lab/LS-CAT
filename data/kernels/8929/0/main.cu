...
cudaMalloc(&tempNodeArray_score, XSIZE*YSIZE);
int *tempNodeArray_vertical = NULL;
cudaMalloc(&tempNodeArray_vertical, XSIZE*YSIZE);
int *tempNodeArray_horizontal = NULL;
cudaMalloc(&tempNodeArray_horizontal, XSIZE*YSIZE);
int *tempNodeArray_matchNum = NULL;
cudaMalloc(&tempNodeArray_matchNum, XSIZE*YSIZE);
int iXSIZE= XSIZE;
int iYSIZE= YSIZE;
