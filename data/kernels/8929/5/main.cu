...
cudaMalloc(&gatewayIndexArray, XSIZE*YSIZE);
const int *indexArray = NULL;
cudaMalloc(&indexArray, XSIZE*YSIZE);
const int *seedWriteIndexArray = NULL;
cudaMalloc(&seedWriteIndexArray, XSIZE*YSIZE);
const int *cellSizeArray = NULL;
cudaMalloc(&cellSizeArray, XSIZE*YSIZE);
const int *tIDArray = NULL;
cudaMalloc(&tIDArray, XSIZE*YSIZE);
const int *tIndexArray = NULL;
cudaMalloc(&tIndexArray, XSIZE*YSIZE);
const int *qIDArray = NULL;
cudaMalloc(&qIDArray, XSIZE*YSIZE);
const int *qIndexArray = NULL;
cudaMalloc(&qIndexArray, XSIZE*YSIZE);
int *target_IDArray = NULL;
cudaMalloc(&target_IDArray, XSIZE*YSIZE);
int *target_indexArray = NULL;
cudaMalloc(&target_indexArray, XSIZE*YSIZE);
int *query_IDArray = NULL;
cudaMalloc(&query_IDArray, XSIZE*YSIZE);
int *query_indexArray = NULL;
cudaMalloc(&query_indexArray, XSIZE*YSIZE);
int iXSIZE= XSIZE;
int iYSIZE= YSIZE;
