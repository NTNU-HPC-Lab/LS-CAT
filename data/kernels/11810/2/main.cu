...
double *Qplus = NULL;
cudaMalloc(&Qplus, XSIZE*YSIZE);
double *viscosity_array = NULL;
cudaMalloc(&viscosity_array, XSIZE*YSIZE);
double *TAURR = NULL;
cudaMalloc(&TAURR, XSIZE*YSIZE);
double *TAURP = NULL;
cudaMalloc(&TAURP, XSIZE*YSIZE);
double *TAUPP = NULL;
cudaMalloc(&TAUPP, XSIZE*YSIZE);
double *DivergenceVelocity = NULL;
cudaMalloc(&DivergenceVelocity, XSIZE*YSIZE);
int nrad = 1;
int nsec = 1;
double *Rmed = NULL;
...
cudaMalloc(&EnergyNew, XSIZE*YSIZE);
double dt = 1;
double *EnergyMed = NULL;
cudaMalloc(&EnergyMed, XSIZE*YSIZE);
double *SigmaMed = NULL;
cudaMalloc(&SigmaMed, XSIZE*YSIZE);
double *CoolingTimeMed = NULL;
cudaMalloc(&CoolingTimeMed, XSIZE*YSIZE);
double *EnergyInt = NULL;
cudaMalloc(&EnergyInt, XSIZE*YSIZE);
double ADIABATICINDEX = 1;
double *QplusMed = NULL;
cudaMalloc(&QplusMed, XSIZE*YSIZE);
int iXSIZE= XSIZE;
int iYSIZE= YSIZE;
