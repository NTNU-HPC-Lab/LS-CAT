...
float *matrices = NULL;
cudaMalloc(&matrices, XSIZE*YSIZE);
const int dimension = 1;
const int coefficients = 1;
const int population = 1;
float *chromosomes = NULL;
cudaMalloc(&chromosomes, XSIZE*YSIZE);
const float *noise = NULL;
cudaMalloc(&noise, XSIZE*YSIZE);
const float mutationRate = 1;
const int kept = 1;
const float *fitnesses = NULL;
cudaMalloc(&fitnesses, XSIZE*YSIZE);
int *mark = NULL;
cudaMalloc(&mark, XSIZE*YSIZE);
const int alpha = 1;
int iXSIZE= XSIZE;
int iYSIZE= YSIZE;
