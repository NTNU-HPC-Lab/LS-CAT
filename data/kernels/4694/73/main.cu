...
cudaMalloc(&output_column_index_array, XSIZE*YSIZE);
int *output_row_index_array = NULL;
cudaMalloc(&output_row_index_array, XSIZE*YSIZE);
int *prev_output_index_array = NULL;
cudaMalloc(&prev_output_index_array, XSIZE*YSIZE);
int *auxiliry_array = NULL;
cudaMalloc(&auxiliry_array, XSIZE*YSIZE);
