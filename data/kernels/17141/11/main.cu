...
cudaMalloc(&feature_weights_, XSIZE*YSIZE);
float *per_class_feature_sum_ = NULL;
cudaMalloc(&per_class_feature_sum_, XSIZE*YSIZE);
float *per_feature_sum_ = NULL;
cudaMalloc(&per_feature_sum_, XSIZE*YSIZE);
float *per_class_sum_ = NULL;
cudaMalloc(&per_class_sum_, XSIZE*YSIZE);
float all_sum_ = 1;
