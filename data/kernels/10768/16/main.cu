...
float *w_ = NULL;
cudaMalloc(&w_, XSIZE*YSIZE);
float *z = NULL;
cudaMalloc(&z, XSIZE*YSIZE);
float *lam1 = NULL;
cudaMalloc(&lam1, XSIZE*YSIZE);
float *lam2 = NULL;
cudaMalloc(&lam2, XSIZE*YSIZE);
float *lam3 = NULL;
cudaMalloc(&lam3, XSIZE*YSIZE);
float *lam4 = NULL;
cudaMalloc(&lam4, XSIZE*YSIZE);
float *lam5 = NULL;
cudaMalloc(&lam5, XSIZE*YSIZE);
float *lam6 = NULL;
cudaMalloc(&lam6, XSIZE*YSIZE);
float *temp = NULL;
