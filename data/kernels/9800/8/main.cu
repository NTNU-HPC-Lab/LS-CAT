...
cudaMalloc(&output_block, XSIZE*YSIZE);
unsigned int *output_val = NULL;
cudaMalloc(&output_val, XSIZE*YSIZE);
unsigned int *output_pos = NULL;
cudaMalloc(&output_pos, XSIZE*YSIZE);
unsigned int *input_val = NULL;
cudaMalloc(&input_val, XSIZE*YSIZE);
unsigned int *input_pos = NULL;
cudaMalloc(&input_pos, XSIZE*YSIZE);
