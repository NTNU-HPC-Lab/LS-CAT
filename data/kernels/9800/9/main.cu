...
cudaMalloc(&d_inputVals, XSIZE*YSIZE);
unsigned int *d_inputPos = NULL;
cudaMalloc(&d_inputPos, XSIZE*YSIZE);
unsigned int *d_outputVals = NULL;
cudaMalloc(&d_outputVals, XSIZE*YSIZE);
unsigned int *d_outputPos = NULL;
cudaMalloc(&d_outputPos, XSIZE*YSIZE);
unsigned int *cu_outputVals = NULL;
cudaMalloc(&cu_outputVals, XSIZE*YSIZE);
size_t numElems = 1;
int iXSIZE= XSIZE;
int iYSIZE= YSIZE;
