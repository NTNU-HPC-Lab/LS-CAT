...
cudaMalloc(&parentArray, XSIZE*YSIZE);
double *resultWeightArray = NULL;
cudaMalloc(&resultWeightArray, XSIZE*YSIZE);
const int *queue = NULL;
cudaMalloc(&queue, XSIZE*YSIZE);
const int *startPoints = NULL;
cudaMalloc(&startPoints, XSIZE*YSIZE);
const int *endPoints = NULL;
cudaMalloc(&endPoints, XSIZE*YSIZE);
const double *weightArray = NULL;
cudaMalloc(&weightArray, XSIZE*YSIZE);
int iXSIZE= XSIZE;
int iYSIZE= YSIZE;
