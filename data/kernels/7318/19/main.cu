...
cudaMalloc(&dev_vol_in, XSIZE*YSIZE);
float *dev_vol_out = NULL;
cudaMalloc(&dev_vol_out, XSIZE*YSIZE);
float *dev_accumulate_weights = NULL;
cudaMalloc(&dev_accumulate_weights, XSIZE*YSIZE);
float *dev_accumulate_values = NULL;
cudaMalloc(&dev_accumulate_values, XSIZE*YSIZE);
int iXSIZE= XSIZE;
int iYSIZE= YSIZE;
