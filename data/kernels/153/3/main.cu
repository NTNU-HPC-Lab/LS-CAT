...
float4 *d_tetT = NULL;
cudaMalloc(&d_tetT, XSIZE*YSIZE);
float *d_vertT = NULL;
cudaMalloc(&d_vertT, XSIZE*YSIZE);
int *d_vertMem = NULL;
cudaMalloc(&d_vertMem, XSIZE*YSIZE);
int *d_vertMemOutside = NULL;
cudaMalloc(&d_vertMemOutside, XSIZE*YSIZE);
int *d_BlockSizes = NULL;
cudaMalloc(&d_BlockSizes, XSIZE*YSIZE);
int *d_ActiveList = NULL;
cudaMalloc(&d_ActiveList, XSIZE*YSIZE);
