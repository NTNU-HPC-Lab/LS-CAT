...
cudaMalloc(&codes, XSIZE*YSIZE);
int *measures = NULL;
cudaMalloc(&measures, XSIZE*YSIZE);
int dimensionsCount = 1;
int *dimendionsSizes = NULL;
cudaMalloc(&dimendionsSizes, XSIZE*YSIZE);
int measuresCount = 1;
int currentCapacity = 1;
int fullCapacity = 1;
int packCount = 1;
int *packDimensions = NULL;
cudaMalloc(&packDimensions, XSIZE*YSIZE);
int *packMeasures = NULL;
cudaMalloc(&packMeasures, XSIZE*YSIZE);
int iXSIZE= XSIZE;
int iYSIZE= YSIZE;
